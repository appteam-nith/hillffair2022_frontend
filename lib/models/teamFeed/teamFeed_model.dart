...
List<TeamFeedModel> teamFeedModelFromJson(String str) => List<TeamFeedModel>.from(json.decode(str).map((x) => TeamFeedModel.fromJson(x)));

String teamFeedModelToJson(List<TeamFeedModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
